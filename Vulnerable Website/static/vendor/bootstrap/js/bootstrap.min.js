...
!(function (t, e) {
  ...
  const s = e(t),
    ...
    a = (t) =>
      r(t) ? (t.jquery ? t[0] : t) : "string" == typeof t && t.length > 0 ? document.querySelector(n(t)) : null,
    l = (t) => {
        ...
        ? (function (t, e, s) {
            return function i(n) {
              ...
              for (let { target: r } = n; r && r !== this; r = r.parentNode)
                for (const a of o)
                  if (a === r) return j(n, { delegateTarget: r }), i.oneOff && M.off(t, n.type, e, s), s.apply(r, [n]);
            };
          })(t, s, r)
        : (function (t, e) {
            return function s(i) {
  ...
  class xt extends W {
    ...
    static dataApiKeydownHandler(t) {
      ...
      const n = this.matches(Et)
          ? this
          : V.prev(this, Et)[0] || V.next(this, Et)[0] || V.findOne(Et, t.delegateTarget.parentNode),
    ...
    show() {
      ...
      if (
        (this._element.ownerDocument.documentElement.contains(this.tip) ||
          (i.append(s), M.trigger(this._element, this.constructor.eventName("inserted"))),
  ...
  const je = "click.bs.scrollspy",
    Fe = "active",
    $e = "[href]",
    ze = { offset: null, rootMargin: "0px 0px -25%", smoothScroll: !1, target: null, threshold: [0.1, 0.5, 1] },
    He = {
      offset: "(number|null)",
      rootMargin: "string",
